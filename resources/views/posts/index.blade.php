...
@section('title', 'Service Station :: home')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12 align-self-center">
                    <h2>Блог о техобслуживании и ремонте автомобилей</h2>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="newsletter-widget text-center align-self-center">
                        ...
                        <form class="form-inline" method="post">
                            <input type="text" name="email" placeholder="Укажите ваш e-mail.." required class="form-control" />
