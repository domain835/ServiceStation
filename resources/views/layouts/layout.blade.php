...
<div id="wrapper">
    <header class="market-header header">
        <div class="container-fluid">
            <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                ...
                <a class="navbar-brand" href="marketing-index.html"><img src="/assets/front/images/version/wheel-logo-small.png" alt=""></a>
    ...
    <section class="section lb @if(Request::is('article')) m3rem @endif">
        <div class="container">
            <div class="row">
